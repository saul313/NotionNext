...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'saul', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'saul的博客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://mygoodland.ga/', // 网站地址
